...
public class ProgramExecutorTest {
    ...
    //!!Changes made to tests for modulo
    // %   Modulo: Pop two values a and b, then push the remainder of the integer division of b/a.
    @Test
    public void pushmod1(){
        _e._ps.push(6);
        _e._ps.push(7);
        _e.modulo();
        assertEquals(6, _e._ps.peek());
    }
    //testing what happens when done with by zero New test to make mod perform better
     @Test
    public void pushmod0(){
        _e._ps.push(0);
        _e._ps.push(-50);
        _e.modulo();
        assertEquals(0, _e._ps.peek());
    }
    //testing with a negative number //new test of modulo operation
     @Test
    public void pushmodnegative(){
        _e._ps.push(-33);
        _e._ps.push(-50);
        _e.modulo();
        assertEquals(-33, _e._ps.peek());
    }
    /*@Test
    public void modulo() {
	_e.modulo();
